...
if __name__ == "__main__":
    ...
    if CALIBRATE:
        ...
        mpu.set_accel_offset(0.048177, -0.017344, 0.120391)
        mpu.set_gyro_offset(0.112352, 0.282778, 0.407069)
    ...
    if LOG_DATA:
        ...
        plotter.plot_measurements('Accel', {'ax': collected_data['ax'], 'ay': collected_data['ay']}, TIMER, name="Accel_Data")
