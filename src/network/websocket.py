...
class WebsocketClient:
    def __init__(self, set_pid_constants, get_pid_constants, calibrate_mpu, start_robot, stop_robot, shutdown_robot, save_settings, switch_PosPid, server_url='http://127.0.0.1:5000'):
